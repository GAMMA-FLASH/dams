...
class EventlistSnapshot():
    ...
    def __dl02dl1(self, group_new, h5_out: tb.Group, idx_new):
        """
        ...
        * `idx_new`: new wf idx to save its name 
        ...
        if len(peaks) == 0:
            ...
            self.carray_new = h5_out.create_carray(group_new, carray_name, atom, shape, f'wf{idx_new}', filters=filters, obj=arr, chunkshape=chunkshape)
            ...
            self.carray_new._v_attrs.tstart1     = -1
            self.carray_new._v_attrs.tend1       = -1
